                ...
                foreach ($q_answers as $q_answer){
                   ...
                   $save['question']['adviser_avatar']=User::find(Auth::user()->id)->avatar;
                    ...
                    if ($save['question']->is_private==0){
                        ...
                        $save['question']['user_id']=null;
                        $save['question']['user_name']='ناشناس';
                        $save['question']['avatar']='/themes/custom-5176/userfiles/fdacd9.jpg';
                    }
    ...
    public function show_question(Request $request)
    {
        ...
        if ($question->is_private == 1) {
            ...
            foreach ($question_a as $answers){
                ...
                $adviser_user_id=Adviser::find($answers->adviser_id)->user_id;
